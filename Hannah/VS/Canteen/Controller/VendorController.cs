...
namespace Canteen.API.Controllers
{
    ...
    public class VendorController : ControllerBase
    {
        ...
        //    }
        //}
        [HttpPost("InsertCombinedVendor")]
        public async Task<ApiResponseMessage<string>> InsertCombinedVendor(CombinedVendorDto dto)
        {
            try
            {
                var res = await _service.InsertCombinedVendor(dto);
                return res;
            }
            catch (Exception ex)
            {
