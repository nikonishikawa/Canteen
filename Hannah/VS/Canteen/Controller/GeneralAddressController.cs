...
namespace Canteen.Controllers
{
    ...
    public class GeneralAddressController : ControllerBase
    {
        ...
        [HttpPost("InsertGeneralAddressWithAddress")]
        public async Task<ActionResult<ApiResponseMessage<string>>> InsertGeneralAddressWithAddress(CombinedAddressGeneralDto dto)
        {
            try
            {
                var res = await _generalAddressService.InsertGeneralAddressWithAddress(dto);
                return res;
            }
            catch (Exception ex)
            {
