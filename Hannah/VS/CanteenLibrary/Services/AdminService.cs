...
namespace CanteenClassLibrary.Services
{
    public class AdminService : IAdminService
    {
        ...
        public async Task<ApiResponseMessage<string>> InsertCombinedAdmin(CombinedAdminDto combinedDto)
        {
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
                try
                {
                    ...
                    {
                        AdminCredentials = generatedCredentialsId,
                        AdminName = generatedNameId,
